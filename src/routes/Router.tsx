	...
	return (
		<Routes location={location} key={location.pathname}>
			...
			<Route element={<PageLayout />}>
				...
				>
					<Route path={ROUTES.editTest} element={<EditTest />} />
					<Route path={ROUTES.entityProfile} element={<ChangeUserInfoPage />} />
				</Route>
				...
				<Route element={<RequireAuth allowedRoles={'all'} />}>
					...
					<Route path={ROUTES.passingTest} element={<PassTestPage />} />
					<Route path={ROUTES.playingGame} element={<PlayGamePage />} />
					<Route path={ROUTES.resultTest} element={<ResultTestPage />} />
				</Route>
				<Route
					element={
				...
				>
					<Route path={ROUTES.myObservers} element={<ObserversPage />} />
				</Route>
			</Route>
		</Routes>
	);
